export const dict = {
  ...
  "command.session.reconcile": "Repair stuck subagents",
  "command.session.reconcile.description": "Clear stale running task state when subagents were interrupted",
  ...
  "toast.session.reconcile.success.title": "Session repaired",
  "toast.session.reconcile.success.description": "Stale subagent state was cleared",
  "toast.session.reconcile.failed.title": "Failed to repair session",
  "toast.session.reconcile.failed.description": "An error occurred while repairing the session",
